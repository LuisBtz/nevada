(self["webpackChunknevada_strapi"] = self["webpackChunknevada_strapi"] || []).push([[994],{
...
/* harmony default export */ const components_FieldComponent = (utils_connect(FieldComponent_Memoized, utils_select));
...
const DynamicZone = ({ name, labelAction, fieldSchema, metadatas }) => {
  ...
  const handleAddComponent = (componentUid, position) => {
    ...
    const componentLayoutData = getComponentLayout(componentUid);
    const allComponents = Object.values(dynamicComponentsByCategory).reduce((acc, components2) => {
      const componentObjects = components2.reduce((acc2, { componentUid: componentUid2, attributes }) => {
        acc2[componentUid2] = {
          attributes,
          uid: componentUid2
        };
...
var SimpleMenu_SimpleMenu = __webpack_require__(17205);
...
const DisplayedFields = ({ editLayout, fields, onRemoveField, onAddField }) => {
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold" }, formatMessage({
    ...
    SimpleMenu_SimpleMenu/* SimpleMenu */.O,
    {
      id: "label",
      label: formatMessage({
    ...
    fields.map((field) => /* @__PURE__ */ react.createElement(SimpleMenu_SimpleMenu/* MenuItem */.s, { key: field, onClick: () => onAddField(field) }, field))
  ))));
};
...
const RelationMultiple = ({ fieldSchema, metadatas, name, entityId, value, contentType }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { ...helper_plugin_esm/* stopPropagation */.UW }, /* @__PURE__ */ react.createElement(
    ...
    status !== "success" && /* @__PURE__ */ react.createElement(SimpleMenu_SimpleMenu/* MenuItem */.s, { "aria-disabled": true }, /* @__PURE__ */ react.createElement(Loader_Loader/* Loader */.a, { small: true }, formatMessage({
      id: (0,utils/* getTrad */.OB)("DynamicTable.relation-loading"),
      defaultMessage: "Relations are loading"
    }))),
    status === "success" && /* @__PURE__ */ react.createElement(react.Fragment, null, data?.results.map((entry) => /* @__PURE__ */ react.createElement(SimpleMenu_SimpleMenu/* MenuItem */.s, { key: entry.id, "aria-disabled": true }, /* @__PURE__ */ react.createElement(TypographyMaxWidth, { ellipsis: true }, /* @__PURE__ */ react.createElement(
      ...
      SimpleMenu_SimpleMenu/* MenuItem */.s,
      {
        "aria-disabled": true,
...
const RepeatableComponentCell = ({ value, metadatas }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { ...helper_plugin_esm/* stopPropagation */.UW }, /* @__PURE__ */ react.createElement(SimpleMenu_SimpleMenu/* SimpleMenu */.O, { label: Label, size: "S" }, value.map((item) => /* @__PURE__ */ react.createElement(SimpleMenu_SimpleMenu/* MenuItem */.s, { key: item.id, "aria-disabled": true }, /* @__PURE__ */ react.createElement(RepeatableComponent_TypographyMaxWidth, { ellipsis: true }, /* @__PURE__ */ react.createElement(CellContent_CellValue, { type: mainFieldType, value: item[mainFieldName] || item.id }))))));
};
...
const SortDisplayedFields = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingBottom: 4 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "delta", as: "h2" }, formatMessage({
    ...
    /* @__PURE__ */ react.createElement(SelectContainer, { size: "auto", paddingBottom: 4 }, /* @__PURE__ */ react.createElement(
      ...
      listRemainingFields.map((field) => /* @__PURE__ */ react.createElement(SimpleMenu_SimpleMenu/* MenuItem */.s, { key: field, onClick: () => handleAddField(field) }, metadatas[field].list.label || field))
    ))
  ));
};
