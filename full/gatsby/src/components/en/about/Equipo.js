...
const Equipo = ({data}) => {
    ...
    const imageIlustrationAlt = data.sanityAboutPage.imagenFinal && data.sanityAboutPage.imagenFinal.textoAlternativo && data.sanityAboutPage.imagenFinal.textoAlternativo.enString;
    ...
    return(
        <EquipoContainer>
            <div className="info">
                <h2>The Team</h2>
                <h3>{data.sanityAboutPage.equipoTitulo && data.sanityAboutPage.equipoTitulo.enString}</h3>
            </div>
            <ul className="equipo">
