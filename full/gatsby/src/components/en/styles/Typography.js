...
import metbolieot from '../../../assets/fonts/MetroSans-Bold.eot';
import metbolsvg from '../../../assets/fonts/MetroSans-Semi-Bold.svg';
import metbolttf from '../../../assets/fonts/MetroSans-Semi-Bold.ttf';
import metbolwoff from '../../../assets/fonts/MetroSans-Semi-Bold.woff';
import metbolwoff2 from '../../../assets/fonts/MetroSans-Semi-Bold.woff2';
...
@font-face {
    ...
    src: url('${metbolieot}');
    src: url('${metbolwoff2}') format('woff2'),
        url('${metbolwoff}') format('woff'),
        url('${metbolttf}') format('truetype'),
        url('${metbolsvg}#PPPangramSans-Semibold') format('svg');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
:root {
    ...
    --semi: 'Metro Semi Bold', sans-serif;
    --bold: 'Metro Bold', sans-serif;
    --black: #000000;
    --white: #ffffff;
    --red: #FF1C00;
