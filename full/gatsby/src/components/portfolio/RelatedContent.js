        ...
        <RelatedContentContainer>
            <div className='top'>
                ...
                <div className='de'>
                    ...
                    <h4><Link to='/portfolio'>Nuestro portafolio</Link></h4>
                </div>
            </div>
            <Slider {...settings}  className="projectList">
                {contRel && contRel.map(({ _id, title, shortDescription, slug, thumbnail }) => {
                    ...
                    const bgGetDataImageAlt = thumbnail.textoAlternativo.esString
                    
                    return (
                        <Link key={_id}  to={`/portfolio/${slug.current}`}>
                            <div className="image">
                                <GatsbyImage
